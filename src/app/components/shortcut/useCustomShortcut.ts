...
import { isValidDomainOrUrl, getDebounceDelay } from '../../hooks/useFaviconDetector';
import { Link } from 'lucide-react';
import { RecommendedSite } from '../../constants/recommendedSitesData';

export function useCustomShortcut(
  onAddToPending: (site: RecommendedSite) => void
) {
