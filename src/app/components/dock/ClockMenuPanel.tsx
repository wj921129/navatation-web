/**
 * 文件名：ClockMenuPanel.tsx
 * 描述：顶部 Dock 栏的组件拖拽菜单面板
 * 创建时间：2026-06-09
 */
        ...
        {activeCategory === 'clock' && (
          <div className="flex items-center gap-3 animate-fade-in">
            ...
            >
              ...
              <span className="text-[10px] text-text-secondary font-light group-hover/btn:text-text-primary">妯℃嫙</span>
            </button>
            ...
            >
              ...
              <span className="text-[10px] text-text-secondary font-light group-hover/btn:text-text-primary">浼犵粺</span>
            </button>
            ...
            >
              <div className="w-16 h-12 rounded-xl border border-widget-border group-hover/btn:border-text-secondary flex flex-col items-center justify-center bg-input-bg">
                ...
                <span className="text-[6px] text-text-secondary scale-90">6鏈?鏃?/span>
              </div>
              <span className="text-[10px] text-text-secondary font-light group-hover/btn:text-text-primary">鏁板瓧</span>
            </button>
            ...
            >
              ...
              <span className="text-[10px] text-text-secondary font-light group-hover/btn:text-text-primary">缈婚〉</span>
            </button>
          </div>
        )}
        ...
        {activeCategory === 'calendar' && (
          <div className="flex items-center gap-3 animate-fade-in">
            ...
            >
              ...
              <span className="text-[10px] text-text-secondary font-light group-hover/btn:text-text-primary">鏈堝巻</span>
            </button>
          </div>
        )}
        ...
        {activeCategory === 'timer' && (
          <div className="flex items-center gap-3 animate-fade-in">
            ...
            >
              ...
              <span className="text-[10px] text-text-secondary font-light group-hover/btn:text-text-primary">鐣寗閽?/span>
            </button>
          </div>
        )}
        ...
        {activeCategory === 'breathe' && (
          <div className="flex items-center gap-3 animate-fade-in">
            ...
            >
              ...
              <span className="text-[10px] text-text-secondary font-light group-hover/btn:text-text-primary">鍐ユ兂</span>
            </button>
          </div>
        )}
        ...
        {activeCategory === 'weather' && (
          <div className="flex items-center gap-3 animate-fade-in">
            ...
            >
              ...
              <span className="text-[10px] text-text-secondary font-light group-hover/btn:text-text-primary">澶╂皵</span>
            </button>
          </div>
        )}
      </div>
