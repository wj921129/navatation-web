import { Calendar, Clock, CloudSun, Timer, Wind, X } from 'lucide-react'
...
export function WidgetGalleryModal({
  ...
  return (
    <BaseModal
      ...
      animationType="scale"
      position="center"
      containerClassName="w-[720px] h-[480px] bg-widget-bg/95 backdrop-blur-3xl border border-widget-border/40 rounded-3xl shadow-2xl flex overflow-hidden"
    >
      {/* 左侧边栏 (Sidebar) */}
      ...
      <div className="flex-1 p-6 relative overflow-y-auto">
        ...
        <div className="mt-8">
          ...
          {/* 统一的网格布局，切换分类时外层不跳动 */}
          <div
            className="grid grid-cols-2 md:grid-cols-3 gap-6 animate-in fade-in slide-in-from-right-4 duration-300 fill-mode-forwards"
            key={activeCategory}
          >
                  ...
                  <div className="w-12 h-12 flex items-center justify-center relative bg-input-bg/20 border border-widget-border rounded-xl">
                    <div className="w-8 h-8 rounded-full bg-white/5 border-2 border-widget-border flex justify-center items-center relative shadow-inner">
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-0.5 h-full py-0.5">
                          <div className="w-full h-1 bg-text-secondary/50 rounded-full" />
                        </div>
                      </div>
                ...
                <div className="w-16 h-16 flex items-center justify-center relative bg-input-bg/20 border border-widget-border rounded-xl shadow-sm overflow-hidden p-1">
                  <div className="w-full h-full flex flex-col gap-0.5">
                    ...
                    <div className="flex justify-between w-full">
                      <div className="w-2 h-2 rounded-sm bg-widget-border" />
                      <div className="w-2 h-2 rounded-sm bg-widget-border" />
                      <div className="w-2 h-2 rounded-sm bg-widget-border" />
                    </div>
                    <div className="flex justify-between w-full">
